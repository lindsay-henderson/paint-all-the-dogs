  ...
  return (
    <div>
      ...
      <div className="process-explanation">
        <p className="p1">I base the pet's portrait on your favorite photos of your pet.  You will email me the photo you would like me to use, along with any other photos that might be a good reference for their sweet face.  if you have a preference for a background, or any fun information about your pet's personality, feel free to let me know, but It's not a requirement.  </p>
